        ...
        <div class="bg-white shadow-xl p-6 rounded-xl flex gap-4 items-center">
            ...
            <div class="w-full">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center border border-gray-300 w-max roundedfull">
                        <button class="cursor-pointer py-1 pl-4 pr-2 text-lg flex itemscenter justify-center">-</button>
                            <div class="py-1 px-2 text-lg flex items-center justifycenter">1</div>
                                <button class="cursor-pointer py-1 pl-2 pr-4 text-lg flex itemscenter justify-center">+</button>
                            </div>
